...
let edinicu = number % 10;
let desyatki = Math.trunc((number % 100) / 10);
let sotni = Math.trunc((number % 1000) / 100);

console.log(
  `В числе ${number} количество сотен: ${edinicu}, десятков: ${desyatki}, единиц: ${sotni}`
);
